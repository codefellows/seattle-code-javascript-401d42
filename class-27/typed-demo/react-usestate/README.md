...
#### Props:
 * {number} - number: the number of times the button was clicked.
...
* {Number} age - a number that represents the age of a person

#### State

* {String} name - a string representing the name of the person.
